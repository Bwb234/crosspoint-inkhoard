...
#include "InkHoardSettingsActivity.h"  // INKHOARD: plan 007
...
void SettingsActivity::rebuildSettingsLists() {
  ...
  // INKHOARD: plan 007
  systemSettings.push_back(SettingInfo::Action(StrId::STR_INKHOARD, SettingAction::InkHoard));
  ...
  if (setting.type == SettingType::TOGGLE && setting.valuePtr != nullptr) {
    ...
    switch (setting.action) {
      ...
      case SettingAction::KOReaderSync:
        ...
        break;
      case SettingAction::InkHoard:  // INKHOARD: plan 007
        startActivityForResult(std::make_unique<InkHoardSettingsActivity>(renderer, mappedInput), resultHandler);
        break;
