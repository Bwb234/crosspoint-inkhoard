...
enum class HomeMenuItem { NONE, FILE_BROWSER, RECENTS, OPDS_BROWSER, INKHOARD, FILE_TRANSFER, SETTINGS_MENU };  // INKHOARD: plan 009
...
class ActivityManager {
 ...
 public:
  ...
  void goToBrowser();
  void goToInkHoard();  // INKHOARD: plan 009
